...
if __name__ == '__main__':
    ...
    if args.test == 'chainer-py2':
        conf = {
            ...
            'nccl': 'none',
            'requires': [
                'setuptools', 'pip', 'cython==0.26', 'numpy<1.14',
        ...
        conf = {
            ...
            'requires': [
                'setuptools', 'pip', 'cython==0.26', 'numpy<1.13',
                'pillow',
            ],
        }
        script = './test.sh'
        ...
        conf = {
            ...
            'nccl': 'nccl1.3.4',
            'requires': [
                'setuptools', 'cython==0.26', 'numpy<1.12',
        ...
        conf = {
            ...
            'cudnn': 'cudnn4',
            'nccl': 'nccl1.3.4',
            'requires': ['setuptools', 'cython==0.26', 'numpy<1.11'],
        }
        ...
        conf = {
            ...
            'nccl': 'none',
            'requires': [
                'pip==9.0.1', 'setuptools', 'cython==0.26', 'numpy<1.14',
        ...
        conf = {
            ...
            'nccl': 'none',
            'requires': [
                'setuptools', 'cython==0.26', 'numpy<1.12', 'scipy<0.19',
            ],
        }
        script = './test_cupy.sh'
        ...
        conf = {
            ...
            'nccl': 'nccl1.3.4',
            'requires': [
                'setuptools', 'cython==0.26', 'numpy<1.11', 'scipy<0.19',
            ],
        }
